...
export const metadata: Metadata = { title: "Üye Ol | PazarBuy" };
    ...
    <>
      ...
      <main className="section-container flex flex-col gap-6 py-10 sm:py-14">
        ...
        <div className="mx-auto w-full max-w-sm rounded-3xl border border-navy-100/80 bg-white p-6 shadow-card sm:p-8">
          ...
          <h1 className="mt-4 text-xl font-extrabold text-navy-900 sm:text-2xl">Hemen Üye Ol</h1>
          <p className="mt-1.5 text-sm text-navy-400">Saniyeler içinde hesabını oluştur, alışverişe başla.</p>
